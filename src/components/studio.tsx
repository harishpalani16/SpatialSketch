...
export default function Studio() {
  ...
  return <main className="studio">
    ...
    <footer className="status-bar"><div className="status-message" role="status" aria-live="polite"><span className="status-dot" />{notice}</div><div className="status-right"><span>{view === 'sketch' ? planeNames[plane] : activeFrame.label}</span><span>POC / 0.3</span><button aria-label="How to use Spatial Sketch" onClick={() => setHelp(!help)}><CircleHelp size={15} /></button></div></footer>
